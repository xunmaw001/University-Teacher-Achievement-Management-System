        ...
        <view @tap="onPageTap('../user-info/userinfo')" class="header" v-bind:class="{'status':isH5Plus}"
            ...
            <view v-if="tableName=='jiaoshi'" class="userinfo">
                <view class="face"
                    ...
                    <image :src="user.jiaoshiPhoto?user.jiaoshiPhoto:'/static/center/face.jpeg'"></image>
                </view>
                <view class="info">
                    <view class="username"
            ...
            <view v-for="item in menuList" v-bind:key="item.roleName">
                <view v-if="role==item.roleName" v-bind:key="index" v-for=" (menu,index) in item.backMenu">
                    <view v-bind:key="sort" v-for=" (child,sort) in menu.child">
                        <view
                                :style='{"backgroundColor":"#47EDB5","borderColor":"#07A771","lineHeight":"80rpx","borderStyle":"solid","borderWidth":"0 0 1rpx  0"}'
