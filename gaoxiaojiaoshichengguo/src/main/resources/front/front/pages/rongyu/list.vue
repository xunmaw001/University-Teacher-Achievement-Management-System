    ...
    <view style="margin: 10rpx 10rpx 10rpx 10rpx;"
        ...
        <view class="listmr">
           ...
           <view style="display: flex;justify-content: space-between;float: left;margin-top: 20%;">
            <text style="margin-left: 50rpx;" v-if="isAuth('rongyu','修改')" class="cuIcon-edit" @click.stop="onUpdateTap(product.id)">
                修改
            </text>
            <text v-if="isAuth('rongyu','删除')" class="cuIcon-delete"
            ...
            v-if="isAuth('rongyu','新增')" class="add-btn" @click="onAddTap()">新增</button>
