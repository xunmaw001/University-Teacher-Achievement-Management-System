    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(yonghu !=null){
            ...
            BeanUtils.copyProperties( yonghu , view );//把实体数据重构到view中
                ...
                //级联表
                JiaoshiEntity jiaoshi = jiaoshiService.selectById(yonghu.getJiaoshiId());
                if(jiaoshi != null){
    ...
    */
    ...
    public R save(@RequestBody YonghuEntity yonghu, HttpServletRequest request){
        ...
        if(StringUtil.isEmpty(role))
            ...
            yonghu.setJiaoshiId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));

        Wrapper<YonghuEntity> queryWrapper = new EntityWrapper<YonghuEntity>()
            .eq("chengguo_name", yonghu.getChengguoName())
            .eq("rongyu_types", yonghu.getRongyuTypes())
            .eq("yonghu_name", yonghu.getYonghuName())
            .eq("yonghu_yesno_types", yonghu.getYonghuYesnoTypes())
            .eq("yonghu_phone", yonghu.getYonghuPhone())
            .eq("jiaoshi_id", yonghu.getJiaoshiId())
            .eq("yonghu_delete", yonghu.getYonghuDelete())
            ;
                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            //循环
                            YonghuEntity yonghuEntity = new YonghuEntity();
//                            yonghuEntity.setChengguoName(data.get(0));                    //标题 要改的
//                            yonghuEntity.setRongyuTypes(data.get(0));                    //类型 要改的
//                            yonghuEntity.setYonghuName(data.get(0));                    //学生姓名 要改的
//                            yonghuEntity.setYonghuPhoto("");//照片
//                            yonghuEntity.setYonghuYesnoTypes(Integer.valueOf(data.get(0)));   //审核结果 要改的
//                            yonghuEntity.setYonghuPhone(data.get(0));                    //手机号 要改的
//                            yonghuEntity.setJiaoshiId(Integer.valueOf(data.get(0)));   //发布教师 要改的
